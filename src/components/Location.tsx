...
const features: FeatureProps[] = [
  {
    icon: image1,
    title: "2840 Broadway",
    description: "(corner of 110th St)",
    footText: "View Store Details",
  },
  {
    icon: image2,
    title: "2589 Broadway",
    description: "(between 97th & 98th St)",
    footText: "View Store Details",
  },
  {
    icon: image3,
    title: "84 Third Avenue",
    description: "(corner Of 12th St)",
    footText: "View Store Details",
  },
  {
    icon: image4,
    title: "180 Third Avenue",
    description: "(between 16th & 17th St)",
    footText: "View Store Details",
  },
  {
    icon: image5,
    title: "77 Seventh Avenue",
    description: "(between 14th & 15th St)",
    footText: "View Store Details",
  },
  {
    icon: image6,
    title: "1407 Lexington Avenue",
    description: "(corner of 92nd St)",
    footText: "View Store Details",
  },
  {
    icon: image7,
    title: "170 West 23rd Street",
    description: "(between 6th & 7th Ave)",
    footText: "View Store Details",
  },
  {
    icon: image8,
    title: "“Our Sister Store” Maywood’s Marketplace",
    description: "78 West Pleasant Avenue Maywood, NJ 07607",
    footText: "Website",
  },
];
...
export const Location = () => {
  return (
    <section id="howItWorks" className="container bg-white text-center">
